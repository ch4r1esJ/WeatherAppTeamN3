...
class SuggestionManager {
    ...
    func getSuggestions(for weatherCode: String) -> [String] {
       
        let iconName = "sunIcon" // აქ მიებმება მერე API
    ...
    func suggestion(for weatherCode: String) -> String {
        let suggestions = getSuggestions(for: weatherCode)
        return suggestions.first ?? "Have a great day! 😊"
    }
}
